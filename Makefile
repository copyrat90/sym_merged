...
PYTHON      	:=  python
SOURCES     	:=  src src/sys src/scn src/fx $(LIBBUTANOLDTK)/src $(BUILDLDTK)/src iso-butano/src
INCLUDES    	:=  include $(LIBBUTANOLDTK)/include $(BUILDLDTK)/include iso-butano/include
DATA        	:=  

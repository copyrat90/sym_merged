...
constexpr bn::string_view variable_8x16_m6x11_utf8_chars[] = {"언", "어"};

constexpr int8_t variable_8x16_m6x11_widths[] = {
...
constexpr bn::sprite_font variable_8x16_m6x11(bn::sprite_items::font_m6x11, variable_8x16_m6x11_utf8_chars,
